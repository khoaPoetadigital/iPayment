...
'input valid email'
WebUI.setText(findTestObject('Sys_Login inf/txt_Email_System_Login'), 'thuataaa@yopmail.com')
...
'verify My venues page appears with text "My Venues"'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Sys_Merchant inf/lbl_MyVenues_System_Merchant'), 5)
