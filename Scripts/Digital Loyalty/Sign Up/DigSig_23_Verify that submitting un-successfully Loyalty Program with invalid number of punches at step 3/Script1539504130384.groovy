...
'input invalid number of punches'
WebUI.setText(findTestObject('Digital Loyalty/Por_Digital inf/txt_NumberofPunches_Por_Dig_Step3'), 'abc')

'input title'
WebUI.setText(findTestObject('Digital Loyalty/Por_Digital inf/txt_RewardTitle_Por_Dig_Step3'), 'reward title')
...
'Verify Error "Your number of punches is not a valid number." displays'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_invalidPunches_step3'), 5)
