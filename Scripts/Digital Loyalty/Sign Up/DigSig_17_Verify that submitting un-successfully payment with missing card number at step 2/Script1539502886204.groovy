...
'verify Error "Credit card must include number, payment_method_nonce, or venmo_sdk_payment_method_code" displays'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_missingcardnumber_step2'), 5)
