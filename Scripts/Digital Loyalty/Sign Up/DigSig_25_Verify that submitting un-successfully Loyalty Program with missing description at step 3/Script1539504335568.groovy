...
'Verify Error "You must provide a description for your program." displays'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_missingDescription_step3'), 5)
