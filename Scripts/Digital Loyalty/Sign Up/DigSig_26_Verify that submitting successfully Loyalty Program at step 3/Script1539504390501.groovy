...
'Verify "Your digital loyalty program has been successfully saved. You should receive your merchant login account in email" displays\n"'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_CompleteStep3'), 5)
