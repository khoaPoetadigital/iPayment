...
'verify Error "You must provide a postal code." displays'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_MissingPostal_Step1'), 5)
