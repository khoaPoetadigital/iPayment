...
'input invalid card'
WebUI.setText(findTestObject('Digital Loyalty/Por_Digital inf/txt_CreditCardNumber_Por_Dig_Step2'), '123456789012')

'submit form'
WebUI.click(findTestObject('Digital Loyalty/Por_Digital inf/btn_SubmitPayment_Por_Dig_Step2'))

'verify Error "Credit card number is invalid." displays'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_invalidcard_step2'), 5)
