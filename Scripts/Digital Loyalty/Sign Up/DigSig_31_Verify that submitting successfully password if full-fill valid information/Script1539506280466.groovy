...
'Sign up digital loyalty successfully'
...
'input number of punches'
WebUI.setText(findTestObject('Digital Loyalty/Por_Digital inf/txt_NumberofPunches_Por_Dig_Step3'), '3')

'input title'
WebUI.setText(findTestObject('Digital Loyalty/Por_Digital inf/txt_RewardTitle_Por_Dig_Step3'), 'title')

'input description'
WebUI.setText(findTestObject('Digital Loyalty/Por_Digital inf/txt_Description_Por_Dig_Step3'), 'this is description 123')
...
'verify Welcome Merchant page appears'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Sys_TermsAgreement inf/btn_Accept_System_TermsAgreement'), 5)
