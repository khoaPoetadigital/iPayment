...
'Leave blank phone\r\n'
WebUI.setText(findTestObject('Por_Digital inf/txt_Phone_Por_Dig_Step1'), '')
...
'Missing Phone error displays\r\n'
WebUI.verifyElementPresent(findTestObject('Por_Digital inf/lbl_MissingPhone_Por_Dig_Step1'), 1)
