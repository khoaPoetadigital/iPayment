...
'verify Error "You must provide your credit_card city" displays'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_missingCity_Step2'), 5)
