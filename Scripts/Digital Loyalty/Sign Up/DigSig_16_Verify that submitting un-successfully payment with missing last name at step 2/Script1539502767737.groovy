...
'verify Error "You must provide the last name on your payment card" displays'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_missinglastname_step2'), 5)
