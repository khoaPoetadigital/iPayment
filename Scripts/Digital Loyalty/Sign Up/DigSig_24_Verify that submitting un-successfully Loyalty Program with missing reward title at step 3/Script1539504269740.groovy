...
'Verify Error "You must provide a reward title for your program." displays'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_missingtitle_step3'), 5)
