...
'input card < 12 numbers'
WebUI.setText(findTestObject('Digital Loyalty/Por_Digital inf/txt_CreditCardNumber_Por_Dig_Step2'), '123456789')

'submit form'
WebUI.click(findTestObject('Digital Loyalty/Por_Digital inf/btn_SubmitPayment_Por_Dig_Step2'))

'verify Error "Credit card number must be 12-19 digits." displays'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_cardBelow12_step2'), 5)
