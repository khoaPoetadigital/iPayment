...
'verify Redirect to Customize Loyalty page with text ""Congratulations!\n""'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_congratulations_step2'), 5)
