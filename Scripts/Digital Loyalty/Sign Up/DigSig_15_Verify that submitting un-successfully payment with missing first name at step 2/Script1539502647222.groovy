...
'verify Error "You must provide the first name on your payment card" displays'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_missingfirstname_step2'), 5)
