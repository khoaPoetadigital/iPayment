...
'input city'
WebUI.setText(findTestObject('Digital Loyalty/Por_Digital inf/txt_City_Por_Dig_Step2'), 'HCM')
...
'verify Error "Street address is required" displays'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Por_Digital inf/lbl_missingstreet_step2'), 5)
