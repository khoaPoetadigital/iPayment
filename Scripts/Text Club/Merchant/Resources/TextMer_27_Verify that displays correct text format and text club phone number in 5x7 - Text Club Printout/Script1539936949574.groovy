...
WebUI.verifyElementText(findTestObject('Text Club/Sys_Dashboard inf/lbl_Resources_5x7PrintoutLarge'), GlobalVariable.var_SMSkeyword)

'Verify displaying correct SMS keyword'
WebUI.verifyElementText(findTestObject('Text Club/Sys_Dashboard inf/lbl_Resources_5x7PrintoutSmall'), GlobalVariable.var_SMSkeyword)
