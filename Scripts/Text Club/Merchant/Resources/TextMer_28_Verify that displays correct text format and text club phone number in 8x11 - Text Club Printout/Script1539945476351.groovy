...
'Verify displaying correct SMS keyword'
WebUI.verifyElementText(findTestObject('Text Club/Sys_Dashboard inf/lbl_Resources_8x11PrintoutLarge'), GlobalVariable.var_SMSkeyword)

'Verify displaying correct SMS keyword'
WebUI.verifyElementText(findTestObject('Text Club/Sys_Dashboard inf/lbl_Resources_8x11PrintoutSmall'), GlobalVariable.var_SMSkeyword)
