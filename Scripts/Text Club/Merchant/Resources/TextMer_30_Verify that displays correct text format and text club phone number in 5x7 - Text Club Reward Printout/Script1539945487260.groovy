...
WebUI.verifyElementText(findTestObject('Text Club/Sys_Dashboard inf/lbl_Resources_5x7RewardLarge'), GlobalVariable.var_SMSkeyword)

'Verify displaying correct SMS keyword'
WebUI.verifyElementText(findTestObject('Text Club/Sys_Dashboard inf/lbl_Resources_5x7RewardSmall'), GlobalVariable.var_SMSkeyword)
