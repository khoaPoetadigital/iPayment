...
WebUI.verifyElementText(findTestObject('Text Club/Sys_Dashboard inf/lbl_Resources_8x11RewardLarge'), GlobalVariable.var_SMSkeyword)

'Verify displaying correct SMS keyword'
WebUI.verifyElementText(findTestObject('Text Club/Sys_Dashboard inf/lbl_Resources_8x11RewardSmall'), GlobalVariable.var_SMSkeyword)
