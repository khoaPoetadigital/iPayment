...
WebUI.verifyElementText(findTestObject('Text Club/Sys_Dashboard inf/lbl_Resources_BusinessCardLarge'), GlobalVariable.var_SMSkeyword)

'Verify displaying correct SMS keyword'
WebUI.verifyElementText(findTestObject('Text Club/Sys_Dashboard inf/lbl_Resources_BusinessCardSmall'), GlobalVariable.var_SMSkeyword)
