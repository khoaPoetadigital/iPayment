...
'verify Error message "Credit card number is invalid." appears'
WebUI.verifyElementPresent(findTestObject('Text Club/Por_TextClub inf/lbl_InvalidCardNumber_Por_TextClub_Step2'), 5)
