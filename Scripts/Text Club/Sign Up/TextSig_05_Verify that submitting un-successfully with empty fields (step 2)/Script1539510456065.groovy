...
WebUI.verifyElementPresent(findTestObject('Text Club/Por_TextClub inf/lbl_MissingCardAdress_Por_TextClub_Step2'), 5)

'Verify that error appears when not input data to required fields'
WebUI.verifyElementPresent(findTestObject('Text Club/Por_TextClub inf/lbl_MissingCardCity_Por_TextClub_Step2'), 5)

'Verify that error appears when not input data to required fields'
WebUI.verifyElementPresent(findTestObject('Text Club/Por_TextClub inf/lbl_MissingCardFirstName_Por_TextClub_Step2'), 5)

'Verify that error appears when not input data to required fields'
WebUI.verifyElementPresent(findTestObject('Text Club/Por_TextClub inf/lbl_MissingCardLastName_Por_TextClub_Step2'), 5)

'Verify that error appears when not input data to required fields'
WebUI.verifyElementPresent(findTestObject('Text Club/Por_TextClub inf/lbl_MissingCardPostal_Por_TextClub_Step2'), 5)

'Verify that error appears when not input data to required fields'
WebUI.verifyElementPresent(findTestObject('Text Club/Por_TextClub inf/lbl_MissingAdress_Por_TextClub_Step2'), 5)
