...
WebUI.setText(findTestObject('Por_TextClub inf/txt_Email_Por_TextClub_Step1'), 'testemail')

WebUI.setText(findTestObject('Por_TextClub inf/txt_Phone_Por_TextClub_Step1'), '123456')
...
WebUI.verifyElementPresent(findTestObject('Por_TextClub inf/lbl_WrongPhone_Por_TextClub_Step1'), 1)
