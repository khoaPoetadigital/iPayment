...
'Input new email\r\n'
WebUI.setText(findTestObject('Por_TextClub inf/txt_Email_Por_TextClub_Step1'), 'thuat22@yopmail.com')
...
WebUI.verifyElementPresent(findTestObject('Por_TextClub inf/lbl_MissingCardAdress_Por_TextClub_Step2'), 0)

WebUI.verifyElementPresent(findTestObject('Por_TextClub inf/lbl_MissingCardCity_Por_TextClub_Step2'), 0)

WebUI.verifyElementPresent(findTestObject('Por_TextClub inf/lbl_MissingCardFirstName_Por_TextClub_Step2'), 0)

WebUI.verifyElementPresent(findTestObject('Por_TextClub inf/lbl_MissingCardLastName_Por_TextClub_Step2'), 0)

WebUI.verifyElementPresent(findTestObject('Por_TextClub inf/lbl_MissingCardPostal_Por_TextClub_Step2'), 0)

WebUI.verifyElementPresent(findTestObject('Por_TextClub inf/lbl_MissingAdress_Por_TextClub_Step2'), 0)

'Verify last data will be auto filled'
WebUI.verifyElementAttributeValue(findTestObject('Por_TextClub inf/txt_City_Por_TextClub_Step2'), 'value', 'HCMC', 0)

'Verify last data will be auto filled'
WebUI.verifyElementAttributeValue(findTestObject('Por_TextClub inf/txt_FirstName_Por_TextClub_Step2'), 'value', 'test', 
    0)

'Verify last data will be auto filled'
WebUI.verifyElementAttributeValue(findTestObject('Por_TextClub inf/txt_LastName_Por_TextClub_Step2'), 'value', 'tester', 
    0)

'Verify last data will be auto filled'
WebUI.verifyElementAttributeValue(findTestObject('Por_TextClub inf/txt_StreetAddress_Por_TextClub_Step2'), 'value', '123 street', 
    0)

'Verify last data will be auto filled'
WebUI.verifyElementAttributeValue(findTestObject('Por_TextClub inf/txt_ZipCode_Por_TextClub_Step2'), 'value', '70000', 0)
