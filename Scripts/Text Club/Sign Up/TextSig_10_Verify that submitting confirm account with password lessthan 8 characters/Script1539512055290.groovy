...
'input password below 8 characters'
WebUI.setText(findTestObject('Text Club/Sys_ConfirmAccount inf/txt_SetPassword_Sys_ConfirmAccount'), '12345?a')

'input confirm password '
WebUI.setText(findTestObject('Text Club/Sys_ConfirmAccount inf/txt_ConfirmPassword_Sys_ConfirmAccount'), '12345?a')
...
WebUI.verifyElementPresent(findTestObject('Text Club/Sys_ConfirmAccount inf/lbl_8characterError_Sys_ConfirmAccount'), 5)
