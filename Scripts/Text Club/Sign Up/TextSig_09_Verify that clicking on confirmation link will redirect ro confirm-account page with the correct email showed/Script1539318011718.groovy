...
'Input new email\r\n'
WebUI.setText(findTestObject('Text Club/Por_TextClub inf/txt_Email_Por_TextClub_Step1'), 'thuat25@yopmail.com')
...
WebUI.selectOptionByIndex(findTestObject('Text Club/Por_TextClub inf/drp_Date_Por_TextClub_Step2'), 3)
...
WebUI.verifyElementPresent(findTestObject('Text Club/Por_TextClub inf/lbl_Congratulations_Por_TextClub_Step3'), 1)
...
'TC line 109\r\n'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Sys_ConfirmAccount inf/txt_SetPassword_Sys_ConfirmAccount'), 1)

WebUI.setText(findTestObject('Digital Loyalty/Sys_ConfirmAccount inf/txt_SetPassword_Sys_ConfirmAccount'), '123456')

WebUI.setText(findTestObject('Digital Loyalty/Sys_ConfirmAccount inf/txt_ConfirmPassword_Sys_ConfirmAccount'), '123456')

WebUI.click(findTestObject('Digital Loyalty/Sys_ConfirmAccount inf/btn_Confirm_Sys_ConfirmAccount'))

'TC line 110\r\n'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Sys_ConfirmAccount inf/lbl_8characterError_Sys_ConfirmAccount'), 1)
...
'TC line 111\r\n'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Sys_ConfirmAccount inf/lbl_1alphabetError_Sys_ConfirmAccount'), 1)

WebUI.setText(findTestObject('Digital Loyalty/Sys_ConfirmAccount inf/txt_SetPassword_Sys_ConfirmAccount'), '123456?a')

WebUI.setText(findTestObject('Digital Loyalty/Sys_ConfirmAccount inf/txt_ConfirmPassword_Sys_ConfirmAccount'), '123456?aaa')

WebUI.click(findTestObject('Digital Loyalty/Sys_ConfirmAccount inf/btn_Confirm_Sys_ConfirmAccount'))

'TC line 112\r\n'
WebUI.verifyElementPresent(findTestObject('Digital Loyalty/Sys_ConfirmAccount inf/lbl_Passwordnotmatch_Sys_ConfirmAccount'), 1)

WebUI.setText(findTestObject('Digital Loyalty/Sys_ConfirmAccount inf/txt_SetPassword_Sys_ConfirmAccount'), '123456?a')

WebUI.setText(findTestObject('Digital Loyalty/Sys_ConfirmAccount inf/txt_ConfirmPassword_Sys_ConfirmAccount'), '123456?a')
