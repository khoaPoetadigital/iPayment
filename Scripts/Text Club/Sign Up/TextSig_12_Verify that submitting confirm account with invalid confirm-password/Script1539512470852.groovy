...
WebUI.setText(findTestObject('Text Club/Sys_ConfirmAccount inf/txt_ConfirmPassword_Sys_ConfirmAccount'), '123456?aa')

'submit password'
WebUI.click(findTestObject('Text Club/Sys_ConfirmAccount inf/btn_Confirm_Sys_ConfirmAccount'))

'verify Error message "Passwords did not match."'
WebUI.verifyElementPresent(findTestObject('Text Club/Sys_ConfirmAccount inf/lbl_Passwordnotmatch_Sys_ConfirmAccount'), 5)
