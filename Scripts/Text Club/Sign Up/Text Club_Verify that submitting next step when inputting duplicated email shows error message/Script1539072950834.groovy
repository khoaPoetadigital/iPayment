...
WebUI.setText(findTestObject('Por_TextClub inf/txt_Email_Por_TextClub_Step1'), 'thuat20@yopmail.com')
...
WebUI.verifyElementPresent(findTestObject('Por_TextClub inf/lbl_DuplicatedEmail_Por_TextClub_Step1'), 1)
