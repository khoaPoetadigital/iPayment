...
WebUI.setText(findTestObject('Text Club/Por_TextClub inf/txt_CreditCardNumber_Por_TextClub_Step2'), '123456789012')

WebUI.click(findTestObject('Text Club/Por_TextClub inf/btn_SubmitPayment_Por_TextClub_Step2'))

'Invalid card number error message appear'
WebUI.verifyElementPresent(findTestObject('Text Club/Por_TextClub inf/lbl_InvalidCardNumber_Por_TextClub_Step2'), 1)
