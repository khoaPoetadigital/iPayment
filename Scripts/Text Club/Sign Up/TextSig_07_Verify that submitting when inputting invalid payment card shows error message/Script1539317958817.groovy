...
WebUI.setText(findTestObject('Por_TextClub inf/txt_CreditCardNumber_Por_TextClub_Step2'), '123456789012')

WebUI.click(findTestObject('Por_TextClub inf/btn_SubmitPayment_Por_TextClub_Step2'))

'Invalid card number error message appear'
WebUI.verifyElementPresent(findTestObject('Por_TextClub inf/lbl_InvalidCardNumber_Por_TextClub_Step2'), 1)
